  ...
  return (
    <div className='px-6 md:px-[100px] mt-8 flex flex-col justify-center items-center'>
        ...
        <form className='w-[80%] flex flex-col space-y-2 md:space-y-3 pb-8'>
            ...
            <input type="text" placeholder='Enter Blog Title' className='px-4 py-2 border-black border-2'/>
            ...
            <textarea rows={6} cols={15} placeholder='Enter Blog Description' className=' px-4 py-2 outline-none border-black border-2'/>
            <button className='w-full bg-black text-white md:w-[20%] mx-auto font-semibold px-4 py-2 text-lg md:text-xl'>UPDATE</button>
        </form>
    </div>
    )
}
